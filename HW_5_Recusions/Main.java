...
//выполнения обоих решений для больших массивов (например, 100000000 элементов).
    ...
    public static int Zad2_binary_search(int[] mySearchedArr, int element, int lowIndex, int highIndex) 
    {
...
//                двигаемся левее от midIndex
            Zad2_binary_search(mySearchedArr, element, lowIndex, midIndex - 1);
        } else if (element > mySearchedArr[midIndex]) 
        {
//                двигаемся правее от midIndex
            Zad2_binary_search(mySearchedArr, element, midIndex + 1, highIndex);
        }
        return -1;
    }
    ...
    public static int Zad2_simple_search(int[] mySearchedArr, int element) 
    {
    ...
    public static void main(String[] args) 
    {
        ...
        Zad2_binary_search(myArr, myElement, 0, myArr.length - 1);
        time1 = System.nanoTime() - time1;
        System.out.printf("Binary search %,9.3f ms\n", time1 / 1_000_000.0);
        long time2 = System.nanoTime();
        Zad2_simple_search(myArr, myElement);
